...
export async function POST(req: NextRequest) {
  try {
    ...
    const htmlContent = `
      ...
      <html lang="en" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
        <head>
          ...
          <title>Order Paid - KaysTrendBoutique</title>
        </head>
          ...
          <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" 
            ...
            <tr>
              <td style="padding:40px; text-align:center;">
                <img 
                  src="https://tsnkaxxoyycsahbhqtez.supabase.co/storage/v1/object/public/logo/kaystrendlogo.jpeg"
    ...
    await transporter.sendMail({
      from: `"KaysTrendBoutique" <${process.env.GMAIL_USER}>`,
      to: email,
